...
return {
  ...
  insert = {
    a = { bg = palette.statusline2, fg = palette.bg1, gui = "bold" },
    b = { bg = palette.bg3, fg = palette.fg },
    c = { bg = palette.bg1, fg = palette.fg },
  },
  visual = {
    a = { bg = palette.statusline3, fg = palette.bg1, gui = "bold" },
    b = { bg = palette.bg3, fg = palette.fg },
    c = { bg = palette.bg1, fg = palette.fg },
  },
  replace = {
    a = { bg = palette.orange, fg = palette.bg1, gui = "bold" },
    b = { bg = palette.bg3, fg = palette.fg },
    c = { bg = palette.bg1, fg = palette.fg },
  },
  command = {
    a = { bg = palette.aqua, fg = palette.bg1, gui = "bold" },
    b = { bg = palette.bg3, fg = palette.fg },
    c = { bg = palette.bg1, fg = palette.fg },
  },
  terminal = {
    a = { bg = palette.purple, fg = palette.bg1, gui = "bold" },
    b = { bg = palette.bg3, fg = palette.fg },
    c = { bg = palette.bg1, fg = palette.fg },
  },
  inactive = {
